Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        MessageBox.Show("An Orc challenges you to a fight!")
    End Sub
    ...
    Private Sub EnemyControl_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EnemyControl.Click
        ...
        MessageBox.Show("The Orc attacks with his mace..!")
        If EnemyHitChance > 60 Then
            MessageBox.Show("The Orc strikes you!")
            PlayerHealth.Increment(-1)
        Else
